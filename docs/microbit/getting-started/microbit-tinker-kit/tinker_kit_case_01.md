...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/5BURByd.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/LZR0LH8.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/9MsaKEF.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/Tinker_Kit_case_01_01.png)
 
因为ADKeypad上有5个按钮，所以我们需要编辑5个类似的条件语句。每个按钮控制一种指定的音调。因此按下不同的按钮，我们就能得到不同音调的音乐。

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/Tinker_Kit_case_01_02.png)
