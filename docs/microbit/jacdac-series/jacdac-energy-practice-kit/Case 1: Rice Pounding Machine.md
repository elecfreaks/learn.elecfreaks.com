...
按下micro:bit主板的**按键A**，舵机开始旋转驱动凸轮机构，模拟古代舂米机往复舂捣谷物的动作。舵机的转速与micro:bit主板**麦克风检测到的声音响度**实时关联——声音越大转速越快、声音越小转速越慢，模拟水流冲击水轮带动水碓的场景：声音代表了"水流的力量"。
...
![360°舵机驱动凸轮](placeholder-servo-cam.png)
...
![水碓](placeholder-water-pestle.png)
...
按下micro:bit主板的**按键A**后，360°舵机开始旋转驱动凸轮机构，带动舂杵上下往复舂捣。对着micro:bit主板大声说话或拍手时，舵机转速加快，模拟"水流湍急、水轮飞转"的场景；环境安静时转速减慢，模拟"水流平缓"；完全安静时舵机停止，模拟"水车停转"。
...
| 触发条件 | 动作 | 来源 |
|---|---|---|
| 按下按键A | 启动循环，持续读取麦克风声音值并控制舵机转速 | micro:bit V2 按键A |
| 麦克风声音响度持续变化 | 舵机转速实时跟随声音大小变化 | micro:bit V2 麦克风 |
