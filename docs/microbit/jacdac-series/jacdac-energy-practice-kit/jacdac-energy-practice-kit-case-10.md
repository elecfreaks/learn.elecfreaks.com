...
| USB数据线 | ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com/docs/microbit/getting-started/microbit-jacdac-smartexploration-
...
如下图所示，将micro:bit主板插入Jacdac扩展板，用连接线将按钮模块和360°积木舵机模块采用**菊花链方式**连接在Jacdac扩展板金手指接口上。
...
| 触发条件 | 动作 | 来源 |
|---|---|---|
| 开机后持续运行 | 读取LED矩阵光敏值（0~255），将其映射为舵机转速，控制风扇转速 | micro:bit V2 LED矩阵光敏检测 |
| 光照越强 | 舵机转速越快，风扇风力越大 | micro:bit V2 LED矩阵光敏检测 |
| 光照越弱 | 舵机转速越慢，风扇风力越小直至停止 | micro:bit V2 LED矩阵光敏检测 |
| 按下外接按钮模块 | 切换风扇手动开关状态（开↔关） | Jacdac 按钮模块 |
