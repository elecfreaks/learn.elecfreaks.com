...
这节课我们将制作一个书籍保护装置，当温湿度传感器检测到温度或者湿度不适合书籍保存时，自动显示红色灯光进行警示。

## 项目制作

### 硬件连接

将温湿度传感器连接到花瓣基础扩展板的IIC接口，

将RGB LED灯连接到花瓣基础扩展板的J1接口。
...
示例程序：[https://makecode.microbit.org/_efohxYEmbLbX](https://makecode.microbit.org/_efohxYEmbLbX)
...
当温湿度传感器检测到温度或者湿度不适合书籍保存时，自动显示红色灯光进行警示。
