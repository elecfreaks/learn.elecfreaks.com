...
XGO 2 版本核心架构上位机是树莓派 CM4/CM5 计算模组，机器狗 AI 相关任务都由上位机完成。下位机使用 ESP32 开发，负责机器狗的电源管理，舵机驱动和核心步态算法等，封装了完整的串口通信协议方便上位机调用。
...
XGO-CM5原理图下载：链接：https://www.elecfreaks.com/download/xgo/raspberry-cm5.pdf
