...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/beCyIpm.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/JQVhM8j.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/vZCaRgF.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/JhTbZcr.png)

In this project, we will use Javascript to code, so first of all, switch to Javascript mode on the top of the page.

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/o8jzFBl.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/XAIZqT3.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/jOLiBBR.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/xLcEWdH.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/3teYV2e.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/T38Jq0z.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/1ljM6dE.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/3AW9ob2.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/KIaOgvL.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/NToYcYx.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/cSmZUSw.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/kUT2zhV.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/AkL0Vuj.jpg)
