...
## Course Objectives
1. Consolidate the programming logic of the sequential execution structure and understand the core principle that "instructions are executed in order";
2. Become familiar with the functions and usage of specified action blocks (such as walking straight, kicking) and servo control blocks (such as head servo rotation);
3. Be able to combine specified actions and servo control blocks with the sequential execution structure to write programs for robot dance moves;
4. Improve program writing, debugging and creative design abilities, and deepen the understanding and application of MakeCode graphical programming.
