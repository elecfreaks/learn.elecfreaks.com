---
sidebar_position: 5
sidebar_label: Case 05 Bravely cross the sky bridge
---
...
1. **Accelerometer**: Measures linear acceleration along one or more axes.

2. **Gyroscope**: Measures angular velocity around one or more axes.
3. **Magnetometer**: Measures the direction of the Earth's magnetic field and is used to determine the absolute or relative orientation of an object.
