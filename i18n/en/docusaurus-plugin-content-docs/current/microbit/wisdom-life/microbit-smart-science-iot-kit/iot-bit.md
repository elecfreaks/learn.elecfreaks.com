...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_01.jpg)
##  Products Link
...
### Size & Installation
 ...
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_02.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_03.png)

### Introduction of main module


 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_04.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_05.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_06.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_07.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_18.gif)

 Plug the micro:bit to the Iot:bit.

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_09.gif)

 Using single USB for power supply to expansion board and switch on.

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_10.gif)
...
#### How to drive the buzzer
 ...
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_13.png)
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_14.png)

 When button A be pressed in the "input", play a bit of music.


 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_15.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_16.jpg)
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_17.png)
 ...
 Press button A to set the time to the set time. On start with RTC function and the minutes be displayed on the 5*5 allay.
  ...
  ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_18.png)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_19.jpg)
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_20.png)
 ...
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_21.png)
...
#### Codebase for other sensors
 ...
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_22.png)
...
### Down load code
 ...
 Let your micro:bit be connected to one side of the USB, the other side to your computer.（Inserting on the expansion board may cause the micro:bit connection to be abnormal or damaged.）
  ...
  ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_23.jpg)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_24.jpg)

 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_25.png)
...
Solution: The nominal voltage for CR1220 button cells is 3V, while some of the cells in the market may have a higher voltage than 3V. The high voltage will make abnormal operation of the RTC happen, to solve this, you can use the used cells or discharge the brand new cells by yourself.
 ...
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_27.jpg)
 ![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_28.JPG)
...
![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_29.JPG)

2. The LED lights up after connection, the button cells in 3.4V would come down to 3V after around 10 seconds.

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_30.JPG)


3. Detect the cells voltage with a multimeter and it works well after deducing the voltage to about 3V.

![](https://wiki-media-ef.oss-cn-hongkong.aliyuncs.com//images/iot_bit_31.JPG)
